...
const myUniContents = () => {
    return (
        ...
        <Grid container spacing={2}>
            <Grid item md={6}>
                <img className="image" style={{ width: "100%", padding: 2 }} alt="entire_diagram" src="img/myuni_entire_diagram.png" />
            </Grid>
            <Grid item md={6}>
                <Typography sx={{ mb: 2 }}>
...
const consultantContents = () => {
    return (
        <Box sx={{ textAlign: 'left '}}>
            <Typography variant='h4' sx={{ mb: 3 }}>
                학교 밖 청소년 전문 진학 컨설턴트/강사 강예은
            </Typography>
            <Grid container spacing={2}>
                <Grid item md={6}>
                    <img className="image" style={{ width: "100%", padding: 2 }} alt="consultant_profile" src="img/consultant_profile.jpg" />
                </Grid>
                <Grid item md={6}>
...
export default function MyUni() {
    ...
    return (
        <React.Fragment>
            <Typography variant='h2' component='h1' sx={{ textAlign: 'left' }}>MYUNI</Typography>
            <Typography variant='body2' component='h1' color="text.secondary" sx={{ mb: 3, textAlign: 'left' }}>검정고시 출신자 맞춤 입시 정보 제공 홈페이지</Typography>
