        ...
        <Box sx={{textAlign: 'left'}}>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item md={6}>
                    ...
                    <Typography sx={{ mb: 2 }}>
                        먼저 검정고시 출신자 지원이 가능한 대학을 구분하고, 대학마다 다른 검정고시 성적 내신 환산 방식을 정리해야 합니다. 심지어는 환산표를 공개하지 않는 대학도 많아 꼼꼼하게 따져봐야 하는데, 이에 더해 학교 밖 청소년 전형 선택 방법이나 대체서식 작성법에 대한 정보가 존재하지 않아 많은 청소년들이 대입을 포기하거나, 아무 대학에나 지원해 입시를 운에 맡기고는 합니다.
                    </Typography>
                    <Typography sx={{ mb: 2 }}>
                ...
                <Grid item xs={12}>
                    <Typography sx={{ mb: 2 }}>
                    MY UNI는 학교 밖 청소년을 학교 교육에서 이탈, 탈락한 존재가 아닌, 학습과 배움을 지속하는 평생 학습자로서 조명하고 이들의 교육과 학습을 적극적으로 지원합니다. 저희 회사는 학교 밖 청소년 전문 진학 컨설팅, 진로 설계 프로그램, 전국 꿈드림 센터 실무자 교육, 면접 교육과 더불어, 실질적인 교육 후원을 진행하고 있습니다
                    </Typography>
                </Grid>
                <Grid item xs={12}>
                    <Typography sx={{ mb: 2 }}>
